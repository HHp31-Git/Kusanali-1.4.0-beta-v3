...
public enum ModArmorMaterial implements ArmorMaterial, StringIdentifiable {
    ...
    COROLLA("corolla", 57, Util.make(new EnumMap(ArmorItem.Type.class), map -> {
        ...
        map.put(ArmorItem.Type.HELMET, 3);
            ...
            3.0F, 0.1F, () -> Ingredient.ofItems(ModItems.ARANAS_FLOWER)),

    CLIENT("client", 33, Util.make(new EnumMap(ArmorItem.Type.class), map -> {
        map.put(ArmorItem.Type.BOOTS, 3);
        map.put(ArmorItem.Type.LEGGINGS, 6);
        map.put(ArmorItem.Type.CHESTPLATE, 8);
        map.put(ArmorItem.Type.HELMET, 3);
    ...
    TROUPE("troupe", 6, Util.make(new EnumMap(ArmorItem.Type.class), map -> {
        ...
        map.put(ArmorItem.Type.HELMET, 1);
            ...
            0.0F, 0.0F, () -> Ingredient.ofItems(Items.STRING));
    ...
    ModArmorMaterial(String name, int durabilityMultiplier, EnumMap<ArmorItem.Type, Integer> protectionAmounts, int enchantability, SoundEvent equipSound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredientSupplier) {
        this.name = name;
    ...
    public String getName() {
        return Kusanali.MOD_ID + ":" + this.name;
    }
